  ...
  const handleSubmit = (e) => {
    ...
    if([nombre, propietario, email, fecha, sintomas].includes('')) {
      ...
      if(paciente.id){
        ...
        const pacientesActualizados = pacientes.map(pacineteState => pacineteState.id === paciente.id ? objetoPaciente : pacineteState);
  ...
  return (
    <div className="md:w-1/2 lg:w-2/5 mx-5">
      ...
      >
          ...
          {error && <Error mensaje='Todos los campos son obligatorios'/>}  {/*Si error es true, entonces imprimir 'Si hay error'*/}
